...
export const certificate = {
  id: 'LM-HYD-2026-000184', instrumentId: 'INS-HYD-0001', type: 'Electronic Weighing Scale', manufacturer: 'ABC Weigh Systems Pvt. Ltd.', model: 'EWS-300', serial: 'EWS300-98231', capacity: '300 kg', owner: 'User Login', location: 'Hyderabad, Telangana', verificationDate: '12 August 2026', validUntil: '11 August 2027', officer: 'Officer R. Kumar', hash: '9f72cbb0e4a6c2f8...a82d'
}

export const instruments: Instrument[] = [
  { id: 'INS-HYD-0001', type: 'Electronic Weighing Scale', manufacturer: 'ABC Weigh Systems', model: 'EWS-300', serial: 'EWS300-98231', capacity: '300 kg', owner: 'User Login', location: 'Hyderabad', certificate: certificate.id, status: 'Verified', expiry: '11 Aug 2027' },
  ...
  { id: 'INS-HYD-0004', type: 'Measuring Instrument', manufacturer: 'Precise Labs', model: 'ML-10', serial: 'PL-10987', capacity: '10 L', owner: 'User Login', location: 'Hyderabad', certificate: 'LM-HYD-2025-000076', status: 'Expired', expiry: '15 Aug 2026' },
...
export const applications: Application[] = [
  { id: 'APP-HYD-2026-001245', applicant: 'A. Sharma', business: 'User Login', instrument: 'Electronic Weighing Scale', district: 'Hyderabad', submitted: '14 Aug 2026', priority: 'High', status: 'Field Verification', officer: 'Officer R. Kumar', date: '18 Aug 2026, 10:30 AM' },
